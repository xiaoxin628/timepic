...
return array(
    ...
    'Korean' => '한국어',
    'About Totoro' => '소개 친칠라',
    'Wallpapermenu' => 'TimePic바탕화면',
    'Wallpaper' => 'TimePic바탕화면',
    'totorotalk' => '친칠라 언어 통역',
    'Help' => '메세지 남겨주세요',
    'Contact Us' => '문의',
    'Leave us a message' => '조언을 남겨주시기 바랍니다.',
    'Click' => '클릭',
    'Close' => '가까운',
    'Anonymous' => '익명',
    'share' => '몫',
    ...
    'n==1#second|n>1#seconds' => '초',
    'n==1#minute|n>1#minutes' => '분',
    'n==1#hour|n>1#hours' => '시간',
    'n==1#day|n>1#days' => '일',
    'n==1#month|n>1#months' => '월',
    'n==1#year|n>1#years' => '년',
    'ago' => '전',
    'now' => '바금',
    /*     * ***models/Msgboard****** */
    'NickName' => '닉네임',
    ...
    'App' => '앺',
    /*     * ***index****** */
    'About TimePic' => 'TimePic 소개',
    'aboutapp' => '소개',
    'Wallpaper_App_caption' => 'TimePic는 카페, 영화, 음악, 리딩, 페티쉬,여행의 LOHAS생활요소를계속하게흡수하여,생활을사랑하는당신과함께마음속의소리를기울입니다.',
    'Wallpaper_App_caption_p' => '<p>TimePic는 카페, 영화, 음악, 리딩, 페티쉬</p><p>여행의 LOHAS생활요소를계속하게흡수하여</p><p>생활을사랑하는당신과함께마음속의소리를기울입니다.</p>',
    'TotoroTalk_App_caption' => '친칠라 애기가 항상 혼자 집에 있습니다. 불쌍하기 짝이 없는 눈치를 볼 때마다 애기한테 엄마가 항상 네 옆에 있다구 말하고 싶습니다. TimePic친칠라 언어 통역 앺 있으면 친칠라 애기와 같이 대화할 수 있습니당.',
    'About_us_caption' => '여행을 좋아함, 자유로운 시간을 좋아함. 우리가 같이 조용한 마음 속으로 들어가고 , 봄의 빛에서  인생의 아름다움을 즐깁시다.',
    /*     * *********totoroCrossCalculator***************** */
    'totoroCrossCalculator' => ' 친칠라 후대 모색 계산기',
    'totoroCrossCalculatorContent' => " 친칠라 후대 모색 계산기",
...
Any calculation involving ebony is treated a bit differently than the rest, since there likely many genotypes that produce the same and/or similar ebony coat colors. When making an ebony cross, bear in mind that the results will show a wider range of possibilities than you might actually encounter in any one particular breeding. The largest percentages will -usually- show you what you can most likely expect, but due to the inability to actually classify the genotypes of your breeding animals, you could still end up with some surprises. I would therefore keep very good records for each mating, keep an open mind and talk to other breeders who might have new and interesting things to say about their experiences, and see what your chins tell you through their offspring. Above all, strive to improve the overall health and quality (this is very good advice for any breeding, come to think of it). ',
    /*     * *********totoroPic***************** */
    'totoroPicmenu' => '친칠라와 얘들의 주인들',
    'totoroPic' => '친칠라와 얘들의 주인들',
    'totoroPicContent' => '친칠라와 얘들의 주인들',

    /*     * *********totoroVideo***************** */
    'totoroVideomenu' => '친칠라 동영상',
    'totoroVideo' => '친칠라 동영상',
    /*     * *********Chinchilla Market***************** */
    'chinchillaMarket' =>'龙猫市场',
    'chinchillaMarketContent' =>'想买龙猫？想卖龙猫？您家的小龙猫是否已经出生？是不是在寻找靠谱的主人？是不是在百度贴吧发帖子被删掉而怒摔？嘿嘿，龙猫市场是为猫友打造的龙猫交易发布平台并与微博互通达到信息快速传播并集中体现。第一时间找到靠谱主人',
);
?>