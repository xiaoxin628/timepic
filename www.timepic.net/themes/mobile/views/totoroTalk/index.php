...
<div class="row-fluid">
	<div class="leftbar">
		<div id="totorologo">
			<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/static/totorotalk/logo.png"/>
		</div>
		<div id="totorointro">
			<div class="caption">
	...
	<div class="rightbar">
		<div id="totoroscreen"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/static/totorotalk/iphonescreen.png"/></div>
	</div>
</div>
